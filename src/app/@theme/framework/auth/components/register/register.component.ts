    ...
    <nb-auth-block>
      ...
      <form (ngSubmit)="register()" #form="ngForm">
        ...
        <div class="form-group">
          <label for="input-name" class="sr-only">نام و نام خانوادگی</label>
          ...
          <small class="form-text error" *ngIf="fullName.invalid && fullName.touched && fullName.errors?.required">
            نام و نام خانوادگی اجباری می باشد!
          </small>
          <small
            class="form-text error"
            *ngIf="fullName.invalid && fullName.touched && (fullName.errors?.minlength || fullName.errors?.maxlength)">
            طول کاراکترهای نام و نام خانوادگی باید
            از {{getConfigValue('forms.validation.fullName.minLength')}}
        ...
        <div class="form-group">
          ...
          <input name="email" [(ngModel)]="user.email" id="input-email" #email="ngModel"
                 class="form-control" placeholder="پست الکترونیک" pattern=".+@.+\..+"
          ...
          <small class="form-text error"
            ...
            فرمت پست الکترونیک باید درست باشد!
          </small>
        </div>
        ...
        <div class="form-group">
          ...
          <small
            ...
            *ngIf="password.invalid && password.touched && (password.errors?.minlength || password.errors?.maxlength)">
            رمز عبور باید شامل 
            از {{ getConfigValue('forms.validation.password.minLength') }}
        ...
        <div class="form-group">
          ...
          <input
            ...
            class="form-control" placeholder="تکرار رمز عبور" #rePass="ngModel"
            [class.form-control-danger]="(rePass.invalid || password.value != rePass.value) && rePass.touched"
            [required]="getConfigValue('forms.validation.password.required')">
          <small class="form-text error"
                 *ngIf="rePass.invalid && rePass.touched && rePass.errors?.required">
            تکرار رمز عبور اجباری می باشد!
          </small>
          <small
            class="form-text error"
            *ngIf="rePass.touched && password.value != rePass.value && !rePass.errors?.required">
            رمز عبور و تکرار رمز عبور همسان نمی باشند!
          </small>
        </div>
        ...
        <div class="form-group accept-group col-sm-12" *ngIf="getConfigValue('forms.register.terms')">
          ...
          با 
           <a href="#" target="_blank"><strong>قوانین و مقررات</strong></a>
موافقم.
          </nb-checkbox>
        </div>
      ...
      <div class="links">
        ...
        <small class="form-text">
          حساب کاربری دارید؟ <a routerLink="../login"><strong> ورود </strong></a>
        </small>
      </div>
    </nb-auth-block>
  `,
